...
namespace KhaiMarket.Server.Infrastructure.Migrations
{
    ...
    [Migration("20240701032234_Initial Migrations For AppUser Identity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KhaiMarket.Server.Entities.Address", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AddressAppUser", b =>
                {
                    b.HasOne("KhaiMarket.Server.Entities.Address", null)
                        .WithMany()
                        .HasForeignKey("AddressesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("KhaiMarket.Server.Entities.AppUser", null)
                        .WithMany()
