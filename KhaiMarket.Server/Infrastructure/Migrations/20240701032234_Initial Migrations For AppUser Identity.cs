...
{
    /// <inheritdoc />
    public partial class InitialMigrationsForAppUserIdentity : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AddressDetail = table.Column<string>(type: "varchar(256)", unicode: false, maxLength: 256, nullable: false),
                    District = table.Column<string>(type: "varchar(100)", unicode: false, maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AddressAppUser", x => new { x.AddressesId, x.AppUserId });
                    table.ForeignKey(
                        name: "FK_AddressAppUser_Address_AddressesId",
                        column: x => x.AddressesId,
                        principalTable: "Address",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AddressAppUser_AspNetUsers_AppUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AddressAppUser_AppUserId",
